...
@Component({
  selector: 'app-pwd-undo-status-to-ok-modal',
  templateUrl: './pwd-undo-status-to-ok-modal.component.html',
  styleUrls: ['./pwd-undo-status-to-ok-modal.component.css']
})
export class PwdUndoStatusToOkModalComponent implements OnInit {
  ...
  constructor(private dialog: MatDialogRef<PwdUndoStatusToOkModalComponent>,
