...
@Component({
  selector: 'app-pwd-prt-confirm-modal',
  templateUrl: './pwd-prt-confirm-modal.component.html',
  styleUrls: ['./pwd-prt-confirm-modal.component.css']
})
export class PwdPrtConfirmModalComponent implements OnInit {
  ...
  constructor(private dialog: MatDialogRef<PwdPrtConfirmModalComponent>,
